...
function initPhoneFinder(){
 ...
 section.innerHTML=`<a class="case-studio-showcase reveal" href="setup.html" aria-label="Customize your own phone case">
   <div class="case-show-copy">
     ...
     <span class="case-show-cta">Customize yours <b>→</b></span>
   </div>
   <div class="case-show-visual" aria-hidden="true">
     <div class="promo-case"><div class="promo-camera"></div><div class="promo-art">HADI<br><small>YOUR STYLE</small></div></div>
     <span class="float-tag tag-photo">＋ Photo</span><span class="float-tag tag-text">T Text</span><span class="float-tag tag-color">● Color</span><span class="float-tag tag-3d">↻ 3D Preview</span>
   </div>
 </a>`;
